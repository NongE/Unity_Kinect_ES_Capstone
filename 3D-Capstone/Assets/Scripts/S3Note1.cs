...
public class S3Note1 : MonoBehaviour
{
    private float time;
    ...
    void Update()
    {
        ...
        if (Stage3BackgroundRepeat.audioSource.time > 2.5f)
        {
        ...
        if (Stage3BackgroundRepeat.audioSource.time > 3.5f)
        {

            Stage3HPManager.hitFlag+=10 ;
