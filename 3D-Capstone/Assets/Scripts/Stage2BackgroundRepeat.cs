...
public class Stage2BackgroundRepeat : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Instantiate(DamageObj, new Vector3(960, 440, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        //34
        ...
        {
            Instantiate(DamageObj, new Vector3(660, 780, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            Instantiate(DamageObj, new Vector3(1260, 780, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
        ...
        {
            Instantiate(DamageObj, new Vector3(960, 380, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        ...
        {
            Instantiate(DamageObj, new Vector3(960, 580, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        if (audioSource.time >= 50.201f && noteCount == 46)
        {
            Instantiate(DamageObj, new Vector3(960, 880, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        ...
        if (audioSource.time >= 51.464f && noteCount == 47)
        {
            ...
            Instantiate(DamageObj, new Vector3(1260, 480, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }

        if (audioSource.time >= 52.73f && noteCount == 48)
        {
            Instantiate(DamageObj, new Vector3(660, 880, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        ...
        {
            Instantiate(DamageObj, new Vector3(660, 480, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            Instantiate(DamageObj, new Vector3(1260, 480, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
        ...
        {
            Instantiate(DamageObj, new Vector3(1260, 560, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }

        if (audioSource.time >= 59.24f && noteCount == 53)
        {
            Instantiate(DamageObj, new Vector3(960, 300, 0), Quaternion.identity, GameObject.Find("Canvas").transform);
            noteCount++;
        }
